...
const defaultComponents = memoizeMarkdownComponents({
  ...
  table: ({ className, ...props }) => (
    <div className="my-2 overflow-hidden rounded-lg border border-zinc-600">
      <table
        className={cn(
  ...
  th: ({ className, ...props }) => (
    <th
      className={cn(
        "aui-md-th border border-zinc-600 rounded-lg bg-zinc-800 px-2 py-1.5 text-left font-bold [[align=center]]:text-center [[align=right]]:text-right",
        className,
      )}
      {...props}
    />
  ...
  td: ({ className, ...props }) => (
    <td
      className={cn(
        "aui-md-td border border-zinc-600 rounded-lg px-2 py-1 text-left [[align=center]]:text-center [[align=right]]:text-right",
        className,
      )}
      {...props}
    />
  ...
  code: function Code({ className, ...props }) {
    ...
    return (
      <code
        className={cn(
          !isCodeBlock &&
            "aui-md-inline-code rounded bg-zinc-700/60 px-1 py-0.5 font-mono text-[0.85em] text-zinc-200",
          className,
        )}
        {...props}
      />
